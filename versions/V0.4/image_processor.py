...
class Preprocessor:
# Description:
#     Preprocessor class provides methods for reading and preprocessing images for the Obscurrra v0.4 program.
#     It includes functionality to read images, resize images, and preprocess images for face detection.
...
class FaceDetection:
    # Description:
    #     FaceDetection class provides methods to detect faces in images using different models for the Obscurrra v0.4 program.
    #     It supports MTCNN, Haar Cascades for frontal faces, and Haar Cascades for profile faces.
...
class FaceBlurrer:
    # Description:
    #     FaceBlurrer class handles the blurring of detected faces in images for the Obscurrra v0.4 program.
    #     It applies a blur effect to the regions of the image where faces have been detected.
...
class ImageProcessor:
    # Description:
    #     ImageProcessor class handles the overall image processing workflow for Obscurrra v0.4.
    #     It uses the Preprocessor, FaceDetection, and FaceBlurrer classes to process images, detect faces, 
    #     and apply blur effects to the detected faces.
